...
- **程序化**：五环节链条 + 8 步工作流 + 20 个思维模型（另含 1 份总览架构图「00毛选思维模型架构图」，故常显示为 21 项），可让 AI 按固定套路产出结构化分析。
...
├── references/
│   ├── models.md            # 20 个思维模型完整拆解（四/五步法 + 历史案例 + 现代应用）
...
| **20 个思维模型** | 实事求是、实践循环、矛盾法则、弹钢琴、集中优势兵力、辩证加工、统筹兼顾、全局统率局部、胸中有数、夺取主动权、感性—理性飞跃、善于总结经验、创造转化条件、灵活机动、预见与阶段划分、群众路线、主客观统一、量变质变、一般与个别结合、分解因式 |
